...
angular.module('articulos').controller('ArticulosController', ['$scope', '$stateParams', '$location', 'Authentication', 'Articulos','Blogs',
	function($scope, $stateParams, $location, Authentication, Articulos, Blogs) {
